...
/***/ (function(module, exports, __webpack_require__) {
	...
	var content = document.querySelector('.input-box');

	var resetResults = function resetResults() {
	  $('.results').html('');
	};

	var startText = 'Data Science is super easy! Type &grave;why&grave; to find out why!';
	var mistakeText = 'Hmmm, that\'s not quite right. Check your spelling and caps!';
	var whyText = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua... Type &grave;graph&grave; to make a graph!';
	var tempGraphText = '[temporary filler until I have a graph set up!]';
	var start = void 0;
	var why = void 0;
	var mistake = void 0;
	var graph = void 0;
	...
	var submit = function submit(e) {
	  ...
	  switch (content.value) {
	    case 'start':
	      start = new _typed2.default('.results', {
	        strings: [startText],
	        typeSpeed: 30
	      });
	      ...
	      break;
	    case 'why':
	      why = new _typed2.default('.results', {
	        strings: [whyText],
	        typeSpeed: 30
	      });
	      ...
	      break;
	    case 'graph':
	      graph = new _typed2.default('.results', {
	        strings: [tempGraphText],
	        typeSpeed: 30
	      });
	      break;
	    default:
	      mistake = new _typed2.default('.results', {
	        strings: [mistakeText],
	        typeSpeed: 30
	      });
	      break;
	...
	var skipPreview = function skipPreview(e) {
	  e.preventDefault();
